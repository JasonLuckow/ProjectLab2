...
"color: rgb(255, 255, 255);")
        ...
        self.littlebtn_2 = QtWidgets.QPushButton(self.centralwidget)
        self.littlebtn_2.setGeometry(QtCore.QRect(760, 500, 271, 36))
        self.littlebtn_2.setMaximumSize(QtCore.QSize(301, 16777215))
        font = QtGui.QFont()
        font.setFamily("SantasSleighFull")
        font.setPointSize(20)
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(50)
        self.littlebtn_2.setFont(font)
        self.littlebtn_2.setCursor(QtGui.QCursor(QtCore.Qt.BlankCursor))
        self.littlebtn_2.setStyleSheet("background-color: rgb(9, 18, 27);\n"
"font: 20pt \"SantasSleighFull\";\n"
"border: 0.5px green;\n"
"color: rgb(255, 255, 255);")
        self.littlebtn_2.setObjectName("littlebtn_2")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.littlebtn_2.setText(_translate("MainWindow", "Pause/Play"))
