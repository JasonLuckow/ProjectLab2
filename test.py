...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-image: url(\"christmasbackground.jpg\");background-repeat: no-repeat; background-position: center;")
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setStyleSheet("background-image: url(\"cat.jpg\"); background-repeat: no-repeat; background-position: center;")
