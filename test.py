...
"color: rgb(255, 255, 255);")
        ...
        self.tempoSlider.setGeometry(QtCore.QRect(810, 540, 160, 22))
        self.tempoSlider.setMinimum(80)
        self.tempoSlider.setMaximum(160)
        self.tempoSlider.setOrientation(QtCore.Qt.Horizontal)
        self.tempoSlider.setObjectName("tempoSlider")
        self.tempoText = QtWidgets.QLabel(self.centralwidget)
        self.tempoText.setGeometry(QtCore.QRect(810, 560, 161, 31))
        self.tempoText.setMaximumSize(QtCore.QSize(600, 1024))
        font = QtGui.QFont()
        font.setFamily("SantasSleighFull")
        font.setPointSize(32)
        font.setBold(False)
        ...
        self.tempoText.setCursor(QtGui.QCursor(QtCore.Qt.BlankCursor))
        self.tempoText.setStyleSheet("color: rgb(255, 255, 255);\n"
"font: 32pt \"SantasSleighFull\";")
        self.tempoText.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.tempoText.setObjectName("tempoText")
        self.progressBar = QtWidgets.QProgressBar(self.centralwidget)
        self.progressBar.setGeometry(QtCore.QRect(760, 350, 261, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tempoText.setText(_translate("MainWindow", "Tempo : 80"))
